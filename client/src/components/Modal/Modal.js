...
const Modal = ({
  ...
  const handleClean = () =>
    setState({ ...state, title: "", cover: "", description: "" });
  ...
  return (
    <div
      className={state.show ? `modal theme-${context.value}` : "modal hide"}
      onClick={handleBtnHeaderClick}
    >
      <div className="modal__content">
        <div className="content__header">
          ...
          <Button
            title="X"
            clsNm="close-button"
            onButtonClick={handleBtnHeaderClick}
          />
        </div>
